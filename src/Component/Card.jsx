...
function Card({num, img, title, desc,link }) {
  ...
  return (
    <div className={`card opacity-0 w-full h-[70vh] relative rounded-3xl card-shadow top-[${num * 20}px] z-[100]`}>
      <div style={{backgroundImage:`url(${img})`}} className='absolute inset-0 opacity-50 rounded-3xl bg-cover bg-center'></div>
